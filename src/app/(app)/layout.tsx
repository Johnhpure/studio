...
import { TemporaryPromptsProvider } from "@/contexts/TemporaryPromptsContext"; // Import the provider

const pageTitles: { [key: string]: string } = {
  "/step1-requirements": "步骤一：输入甲方核心需求",
  "/step2-outline-generator": "步骤二：AI生成稿件创作大纲",
  "/step3-style-learning": "步骤三：AI学习您的写作风格",
  "/step4-draft-creation": "步骤四：AI智能创作初稿",
...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <TemporaryPromptsProvider> {/* Wrap with the provider */}
